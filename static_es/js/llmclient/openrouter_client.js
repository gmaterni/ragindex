...
const adaptOpenRouterPayload = (payload) => {
  if (!payload.model) {
...
class OpenRouterClient {
  ...
  async sendRequest(payload, timeout = 60) {
    ...
    const headers = {
      ...
      "HTTP-Referer": "https://github.com/u-a/llm_test_js", // Optional but recommended
      "X-Title": "LLM Model Tester", // Optional but recommended
    };
